...
Name:           ros-kilted-jig-example
Version:        0.0.2
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS jig_example package

License:        Apache 2.0
URL:            https://index.ros.org/p/jig_example/#kilted
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-example-interfaces
Requires:       ros-kilted-geometry-msgs
Requires:       ros-kilted-jig
...
%description
An example node using the jig system.
